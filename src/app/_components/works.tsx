...
export default function Works() {
    ...
    return (
        <section className="w-full flex flex-col gap-24 3xl:px-[260px] xs:py-[120px] xs:px-10 2xl:px-20 pt-[120px]">
            <div
                ref={headerRef}
            ...
            >
                <div className="flex flex-col gap-2 items-center">
                    <div
                        className={`w-fit text-center text-white px-3 py-2 rounded-3xl bg-[#28282C] transition-all duration-800 ease-out ${
                            headerInView
